...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand\JOB{Plant Genomics and Machine Learning Scientist}
\newcommand\POSTING{Plant Genomics and Machine Learning Scientist}
\newcommand\COMPANY{the CRUK-SI Data Science Team}
\newcommand\EMPLOYER{Rebecca Kyte and Recruitment Team}
\newcommand\REF{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\name{Matthew Pace}
